...
namespace Library.BLL
{
    public class PedidoService
    {
        ...
        private readonly PedidoItemRepository _repositoryPedidoItem;
        private readonly PedidoHistoricoRepository _pedidoHistoricoRepository;

        public PedidoService(
            PedidoRepository repository, 
            ClienteRepository repositoryCliente, 
            PedidoItemRepository repositoryPedidoItem,
            PedidoHistoricoRepository pedidoHistoricoRepository)
        {
            ...
            ListaPedidoRequest pedidoLista)
        {
            ...
            try
            {
                ...
                await _repository.AdicionarEstorico(pedido);
        ...
        public async Task AlterarStatus(Pedido pedido, StatusPedido novoStatus, string? motivo = null)
        {
            ...
            await _repository.AdicionarEstorico(pedido, motivo);
        }
    }
}
